      ...
      <div className="relative grid w-full max-w-4xl gap-8 lg:grid-cols-2">
        ...
        <div className="hidden flex-col justify-center lg:flex">
          <h1 className="text-4xl font-bold">
            Start building with{" "}
            <span className="gradient-text">OpenRouter</span>
          </h1>
          <p className="mt-4 text-lg text-muted-foreground">
            Join thousands of developers accessing the world&apos;s best AI
            models through a single, unified API.
          </p>
        ...
        <Card className="border-border/50 bg-card/80 backdrop-blur-xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>Get started with OpenRouter today</CardDescription>
          </CardHeader>
          <CardContent>
